...
local function jdtls_on_attach(client, bufnr)
  ...
  vim.keymap.set('n', '<leader>jwa', function() vim.lsp.buf.add_workspace_folder() end, bufopts)
  vim.keymap.set('n', '<leader>jwr', function() vim.lsp.buf.remove_workspace_folder() end, bufopts)
  vim.keymap.set('n', '<leader>jwl', function() print(vim.inspect(vim.lsp.buf.list_workspace_folders())) end, bufopts)
  vim.keymap.set('n', '<leader>jD',  function() vim.lsp.buf.type_definition() end, bufopts)
  vim.keymap.set('n', '<leader>jrn', function() vim.lsp.buf.rename() end, bufopts)
  vim.keymap.set('n', '<leader>jlg', function() vim.lsp.buf.formatting_sync(nil, 1000) end, bufopts)
  vim.keymap.set('n', '<leader>jlA', function() vim.lsp.buf.code_action() end, bufopts)

  vim.keymap.set('n', '<leader>je',  function() vim.lsp.diagnostic.show_line_diagnostics() end, opts)
  vim.keymap.set('n', '<leader>jq',  function() vim.lsp.diagnostic.set_loclist() end, opts)
  vim.keymap.set('n', '<leader>jf', function() vim.lsp.buf.format() end, bufopts)
